...
public class Cabang {
    ...
    //methods
    public void tambahPegawai(String namaPegawai, String jabatan, int gaji, boolean isPegawaiTetap, int lamaBekerja) {
        n++;
        Pegawai pegawaiBaru;
        if (isPegawaiTetap) {
            pegawaiBaru = new PegawaiTetap(namaPegawai, jabatan, gaji, lamaBekerja);
        } else {
            pegawaiBaru = new PegawaiHarian(namaPegawai, jabatan, gaji, lamaBekerja);
        }
